    ...
    func body(content: Content) -> some View {
        ZStack {
            ...
            if rotation < 90 {
                ...
                shape.fill().foregroundColor(Color(#colorLiteral(red: 0.4941176471, green: 0.2274509804, blue: 0.4901960784, alpha: 0.1022810778)))
//                shape.strokeBorder(lineWidth: DrawingConstants.lineWidth)
                shape.stroke(Color(#colorLiteral(red: 0.4941176471, green: 0.2274509804, blue: 0.4901960784, alpha: 1)), lineWidth: DrawingConstants.lineWidth)
            } else {
                shape.fill().foregroundColor(Color(#colorLiteral(red: 0.4941176471, green: 0.2274509804, blue: 0.4901960784, alpha: 1)))
            }
